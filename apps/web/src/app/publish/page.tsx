...
function PublishPageInner() {
  ...
  useEffect(() => {
    ...
    // Handle redirect back from Instagram OAuth
    if (searchParams.get('instagram_connected') === '1') {
      ...
      setActiveTab('accounts');
      showToast(`❌ Instagram: ${searchParams.get('instagram_error')}`, 'error');
    }
            ...
            <div className="bg-white/[0.03] border border-white/8 rounded-2xl p-5 mb-8">
              {(() => {
                ...
                if (igConn) {
                  return (
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl shrink-0 bg-[#e1306c18]">
                        📸
                      </div>
                      <div className="flex-1 min-w-0">
                ...
                return (
                  <a
                    ...
                    className="w-full flex items-center justify-center gap-2.5 py-3 bg-[#e1306c] hover:bg-[#c92a5f] text-white font-bold text-sm rounded-xl transition-all shadow-lg shadow-[#e1306c35]"
                  >
                    <span className="text-base">📸</span>
                    Connect Instagram (Reels)
                  </a>
                );
              })()}
            </div>
